...
";
    ...
    $clausulas = [
        ...
        "TERCERA. GARANTÍA" => "        En garantía de la restitución del préstamo, el Mutuario libra a favor del Mutuante un pagaré por la suma de " . $pdf->numeroAPalabras($monto_total) . " ($" . number_format($monto_total, 2, ',', '.') . ") igual valor recibido en servicios, a mi entera satisfacción, al Sr. WASHINGTON HORACIO RODRIGUEZ ROSAS o a su orden, el cual será restituido al cancelarse todas las cuotas adeudadas. En caso de ser necesario accionar judicialmente, el Mutuante se obliga a accionar por el pagaré o por el presente contrato, pero no por ambos. -",
