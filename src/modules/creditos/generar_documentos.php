...
if ($tipo == 'pagare') {
    ...
    $pdf->SetXY(-50, 30);
    $pdf->Cell(0, $lineHeight, $pdf->convertirTexto('Por $' . number_format($monto, 2, ',', '.') . '-'), 0, 1, 'L');
